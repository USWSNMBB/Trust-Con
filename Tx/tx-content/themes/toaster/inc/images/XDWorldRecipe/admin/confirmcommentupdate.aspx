...
<script runat="server">
 ...
 { 
     ...
     if (strMode == "del") 
     {
         lblconfirm.Text = strCatName + "&nbsp;Comment Has Been Successfully Deleted";
     }
     else if (strMode == "add") 
     {
         lblconfirm.Text = strCatName + "&nbsp;Comment Has Been Successfully Added";
     }
     else if (strMode == "update") 
     {
         lblconfirm.Text = strCatName + "&nbsp;Comment Has Been Successfully Updated";
     }  
 }
</script>
